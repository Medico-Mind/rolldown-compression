...
- [`4682438`](https://github.com/Medico-Mind/rolldown-compression/commit/4682438766c5b481b18bd5ebfacf231e5da2353c) Thanks [@Mnwa](https://github.com/Mnwa)! - Migrate brotli encoding to `mbrotli`.
...
- [`0818b8d`](https://github.com/Medico-Mind/rolldown-compression/commit/0818b8d039ee24529c72b6db5ed453e3e3748368) Thanks [@Mnwa](https://github.com/Mnwa)! - Fix the WebAssembly fallback build by using the same zstd version as native builds while preserving its no-assembly configuration.
